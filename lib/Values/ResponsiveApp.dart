...
import 'package:ui/Util/Sizinginfo.dart';
...
class ResponsiveApp 
{
  ...
  ResponsiveApp(this._context)
    ...
    _scaleFactor = isMobile(_context)?1:isTablet(_context)?1.1:1.3; //Multiplicando la escala, cambiamos el tamaño de los elementos
    edgeInsetsApp=EdgeInsetsApp(this);
      ...
      setSp(int fontSize) => //Para modificar la escala de los textos
